...
#    Updated: 2024/01/21 07:50:02 by olimarti         ###   ########.fr        #
#                                                                              #
# **************************************************************************** #
...
CC = cc
CFLAGS = -Wall -Wextra -Ofast# -g #-O3 -pg -g3# -fsanitize=address -fsanitize=leak#-g #-fpie #-fsanitize=leak -fsanitize=address
LIBA = ar rc
LIBS = ranlib
