...
#    Updated: 2023/12/30 15:18:46 by olimarti         ###   ########.fr        #
#                                                                              #
# **************************************************************************** #
...
CC = cc
CFLAGS = -Wall -Wextra -Ofast # -fopenmp#-g3#-O3 -pg -g3# -fsanitize=address -fsanitize=leak#-g #-fpie #-fsanitize=leak -fsanitize=address
LIBA = ar rc
LIBS = ranlib
