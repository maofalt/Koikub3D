...
#    Updated: 2024/02/01 22:57:36 by olimarti         ###   ########.fr        #
#                                                                              #
# **************************************************************************** #
...
CC = cc
CFLAGS = -Wall -Wextra -Ofast -flto #-O3 -pg -g3# -fsanitize=address -fsanitize=leak#-g #-fpie #-fsanitize=leak -fsanitize=address
LIBA = ar rc
LIBS = ranlib
