...
#    Updated: 2024/02/26 23:50:15 by olimarti         ###   ########.fr        #
#                                                                              #
# **************************************************************************** #
...
CC = cc
CFLAGS = -Wall -Wextra -flto -Ofast #-O3 -pg -g3# -fsanitize=address -fsanitize=leak#-g #-fpie #-fsanitize=leak -fsanitize=address
LIBA = ar rc
LIBS = ranlib
