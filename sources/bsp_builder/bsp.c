...
/*   Updated: 2023/12/01 05:11:12 by olimarti         ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
int	_recursive_map_cut_create_leaf(t_list **bsp_segments, t_tree_node **tree)
{
	...
	if (tree_node == NULL)
		return (1);
	((t_bsp_tree_node_data *)tree_node->data)->sector_data.floor = DEFAULT_FLOOR;
	((t_bsp_tree_node_data *)tree_node->data)->sector_data.ceil = DEFAULT_CEIL;
