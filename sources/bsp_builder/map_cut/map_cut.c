...
/*   Updated: 2023/11/02 03:00:03 by olimarti         ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
int	cut_portal(t_bsp_segment *bsp_segment, t_bsp_segment **right_portal_1, t_bsp_segment **right_portal_2)
{
	...
	if (cut_segment(bsp_segment->segment->data.data.portal.destination,
		right_portal_2))
	{
...
int	cut_segment_to_node(t_list **bsp_segment_node, t_list **left, t_list **right)
{
	...
	else
	{
		...
		ft_lstadd_front(&bsp_segment->node_ptr->next, new_node_right);
