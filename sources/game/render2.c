...
/*   Updated: 2023/11/19 16:29:14 by olimarti         ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
// inline static void	clamp_projection(
// 		t_segment_d *wall,
// 		double *left,
// 		double *right
// 		)
// {
// 	*left = fmax(wall->point_a.x, *left);
// 	*right = fmin(wall->point_b.x, *right);
// }
